...
my $uploaded_files_path = "/var/www/cgi-bin/rpatward/debruijn/gapped/writable";
my $program_path = "/var/www/cgi-bin/rpatward/debruijn/gapped";
...
#    my $nsites = param('nsites');
    ...
    system("perl $program_path/$motif_program -fam $uploaded_files_path/file1.txt -sub $matrix_path/$matrix.txt  -th $scale_threshold -mth $scale_max_threshold ");
