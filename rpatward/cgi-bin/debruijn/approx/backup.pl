...
# July 6, 2006: Modification to prevent cycles within a motif using edge_dup
...
print "<br>\nThe number of sequences in the input is <b>$number_of_seq</b><br><br>\n";
...
print "Initial Graph created<br><br>\n";
